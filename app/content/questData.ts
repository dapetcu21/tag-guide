    ...
    questions: [
      {
        ...
        correctInputs: ["game", "field", "fool", "victim", "joc", "terenul", "mâinile", "norocul", "viața", "viitorul", "cariera", "reputația", "șansele", "regulile", "față", "mișcare", "race card", "gallery", "odds", "part"],
      },
      {
        id: "t1q1i2",
